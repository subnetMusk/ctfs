...
A finite field Fp is the set of integers 0,1,...,p−1, and under both addition
and multiplication there are inverse elements b+ and b∗ for every element a in
the set, such that a+b+=0 and a⋅b∗=1.

Note that the identity element for addition and multiplication is different!
This is because the identity when acted with the operator should do nothing:
a+0=a and a⋅1=a.
...
Now take the prime p=65537. Calculate 273246787^(65465536) mod 65537.

Did you need a calculator?
'''

# non ci sono grossi calcoli da svolgere. Vedere:
